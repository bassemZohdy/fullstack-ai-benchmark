...
> to the per-harness skills. See `.agents/skills/harness-opencode/SKILL.md`, `.agents/skills/harness-pi/SKILL.md`,
> and the other `.agents/skills/harness-*/SKILL.md` files.
...
- Harness abstraction functions: see `.agents/skills/harness-opencode/SKILL.md` and `.agents/skills/harness-pi/SKILL.md`
