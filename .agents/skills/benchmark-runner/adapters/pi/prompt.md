...
Build strategy: minimal compileable scaffold first, simplest working implementation. Do NOT run `npm install` or `mvn install` — just write the source files.
